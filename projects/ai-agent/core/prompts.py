...
SYSTEM_PROMPT: Final = """You are an intelligent AI assistant with access to an internal knowledge base (vector database) containing documents in Markdown format, as well as persistent memory tools.
